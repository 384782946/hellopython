...
from PyQt4.QtGui import QColor,QPalette, QWidget, QDialog, QVBoxLayout,\
    QHBoxLayout, QMessageBox, QApplication, QGridLayout, QLabel
import sys
...
class MyDialog(QDialog):
    def __init__(self):
        ...
        self.scoreView = QLabel("0")
        self.gridLayout = QGridLayout()
        self.gridLayout.setSpacing(5)
        self.rootLayout = QVBoxLayout()
        self.vboxLayout = QHBoxLayout()
        self.label= QLabel("Press space key to start.   Score:")
